...
| RAM (útil, `link.ld`)  | `0x00008000` | 160K − 24 bytes  | —      | —       |
| mailbox_addr           | `0x0002FFFC` | 1 palavra        | —      | —       |
| go_flag_addr           | `0x0002FFF8` | 1 palavra        | —      | —       |
| fromhost               | `0x0002FFF0` | 2 palavras       | —      | —       |
| tohost                 | `0x0002FFE8` | 2 palavras       | —      | —       |
| `_stack_top` (sp)      | `0x0002FFE8` | —                | —      | —       |
